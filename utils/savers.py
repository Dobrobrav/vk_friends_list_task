...
class CSVSaver(ISaver, LocalStorageSaverMixin):
    ...
    def save(self,
        ...
        logs.utils.for_savers.log_start_saving(self._output_path, 'csv')
        ...
        logs.utils.for_savers.log_finish_saving(self._output_path, 'csv')
...
class TSVSaver(ISaver, LocalStorageSaverMixin):
    ...
    def save(self,
        ...
        logs.utils.for_savers.log_start_saving(self._output_path, 'tsv')
        ...
        logs.utils.for_savers.log_finish_saving(self._output_path, 'tsv')
...
class JSONSaver(ISaver, LocalStorageSaverMixin):
    ...
    def save(self,
        ...
        logs.utils.for_savers.log_start_saving(self._output_path, 'json')

        with open(f'{self._output_path}.json', mode='w',
                  encoding='utf-8', newline='') as file:
            json.dump(friends, fp=file, ensure_ascii=False)

        logs.utils.for_savers.log_finish_saving(self._output_path, 'json')
